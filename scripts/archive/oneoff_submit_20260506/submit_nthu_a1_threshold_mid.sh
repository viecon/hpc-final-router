...
RESULT_TAG=${RESULT_TAG:-a1_threshold_mid}
...
nthu_a1_th1350|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1350|
nthu_a1_th1400|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1400|
nthu_a1_th1450|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1450|
EOF
