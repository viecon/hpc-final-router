...
RESULT_TAG=${RESULT_TAG:-a3_skip_step12_threshold}
...
nthu_a3_skip_step12_th3200|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=3200|NTHU_DOGLEG_FASTPATH=1 NTHU_DOGLEG_MAX_EXTRA=0 NTHU_DOGLEG_MIN_SCORE=1 NTHU_DOGLEG_STEP=12 NTHU_RANGE_SKIP_REMAINDER=1
nthu_a3_skip_step12_th4000|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=4000|NTHU_DOGLEG_FASTPATH=1 NTHU_DOGLEG_MAX_EXTRA=0 NTHU_DOGLEG_MIN_SCORE=1 NTHU_DOGLEG_STEP=12 NTHU_RANGE_SKIP_REMAINDER=1
nthu_a3_skip_step12_th4800|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=4800|NTHU_DOGLEG_FASTPATH=1 NTHU_DOGLEG_MAX_EXTRA=0 NTHU_DOGLEG_MIN_SCORE=1 NTHU_DOGLEG_STEP=12 NTHU_RANGE_SKIP_REMAINDER=1
EOF
