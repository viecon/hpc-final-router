...
RESULT_TAG=${RESULT_TAG:-cuda_radius_a3_step6}
...
common_env="NTHU_DOGLEG_FASTPATH=1 NTHU_DOGLEG_MAX_EXTRA=0 NTHU_DOGLEG_MIN_SCORE=1 NTHU_DOGLEG_STEP=6 NTHU_CUDA_DOGLEG_PRESELECT=1 NTHU_CUDA_DOGLEG_LEGAL_FILTER=1 NTHU_CUDA_DOGLEG_TRUST_LEGAL_FILTER=1 NTHU_CUDA_DOGLEG_MIN_BATCH=64 NTHU_CUDA_DOGLEG_SKIP_CPU_FALLBACK=1"

cat > "$variants_file" <<EOF
nthu_a3_cuda_radius4_gpuonly|$common_args|$common_env NTHU_DOGLEG_RADIUS=4
nthu_a3_cuda_radius6_gpuonly|$common_args|$common_env NTHU_DOGLEG_RADIUS=6
nthu_a3_cuda_radius8_gpuonly|$common_args|$common_env NTHU_DOGLEG_RADIUS=8
EOF
