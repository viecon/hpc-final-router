...
RESULT_TAG=${RESULT_TAG:-cuda_costed_maze_a1_gatefix}
...
nthu_a1_cuda_costed_maze_score1_gatefix|$args|$cuda_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=1
nthu_a1_cuda_costed_maze_score5_gatefix|$args|$cuda_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=5
nthu_a1_cuda_costed_maze_score10_gatefix|$args|$cuda_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=10
nthu_a1_cuda_costed_maze_score25_gatefix|$args|$cuda_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=25
EOF
