...
RESULT_TAG=${RESULT_TAG:-cuda_costed_maze_a1_high_threshold}
...
nthu_a1_th3200_costed_score10|$base_args --overflow-threshold=3200|$cuda_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=10
nthu_a1_th3200_costed_score25|$base_args --overflow-threshold=3200|$cuda_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=25
nthu_a1_th12000_costed_score10|$base_args --overflow-threshold=12000|$cuda_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=10
nthu_a1_th12000_costed_score25|$base_args --overflow-threshold=12000|$cuda_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=25
EOF
