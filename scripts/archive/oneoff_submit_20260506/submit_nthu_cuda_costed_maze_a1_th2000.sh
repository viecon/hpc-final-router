...
RESULT_TAG=${RESULT_TAG:-cuda_costed_maze_a1_th2000}
...
args="--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=2000 --p3-init-box-size=20 --p3-box-expand-size=30"
base_env="NTHU_CUDA_COSTED_MAZE_FASTPATH=1 NTHU_CUDA_MAZE_MAX_AREA=256"

cat > "$VARIANTS_FILE" <<EOF
nthu_a1_th2000_costed_score25|$args|$base_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=25
nthu_a1_th2000_costed_score50|$args|$base_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=50
EOF
