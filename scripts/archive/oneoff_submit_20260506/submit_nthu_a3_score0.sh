...
RESULT_TAG=${RESULT_TAG:-dogleg_score_a3_score0}
...
nthu_a3_repeat_score0|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=4000|
nthu_a3_dog_score0|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=4000|NTHU_DOGLEG_FASTPATH=1 NTHU_DOGLEG_MAX_EXTRA=0 NTHU_DOGLEG_MIN_SCORE=0
EOF
