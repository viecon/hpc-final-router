...
RESULT_TAG=${RESULT_TAG:-cuda_costed_maze_a2_dogleg_gatefix}
...
args="--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=245 --p3-init-box-size=20 --p3-box-expand-size=30"
...
nthu_a2_dogleg_score500_reference_gatefix|$args|$base_env
nthu_a2_dogleg_cuda_costed_score25_gatefix|$args|$cuda_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=25
nthu_a2_dogleg_cuda_costed_score50_gatefix|$args|$cuda_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=50
nthu_a2_dogleg_cuda_costed_score100_gatefix|$args|$cuda_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=100
EOF
