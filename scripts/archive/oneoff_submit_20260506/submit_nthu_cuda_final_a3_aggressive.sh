...
RESULT_TAG=${RESULT_TAG:-cuda_final_a3_aggressive}
...
cuda_env="$base_env NTHU_CUDA_DOGLEG_PRESELECT=1 NTHU_CUDA_DOGLEG_LEGAL_FILTER=1 NTHU_CUDA_DOGLEG_TRUST_LEGAL_FILTER=1 NTHU_CUDA_DOGLEG_TRUST_FINAL_CHECK=1"

cat > "$variants_file" <<EOF
nthu_a3_final_cuda_aggr_min64|adaptec3*.gr|$attempts|$cuda_env NTHU_CUDA_DOGLEG_MIN_BATCH=64
nthu_a3_final_cuda_aggr_min128|adaptec3*.gr|$attempts|$cuda_env NTHU_CUDA_DOGLEG_MIN_BATCH=128
nthu_a3_final_cuda_aggr_min256|adaptec3*.gr|$attempts|$cuda_env NTHU_CUDA_DOGLEG_MIN_BATCH=256
nthu_a3_final_cuda_aggr_min512|adaptec3*.gr|$attempts|$cuda_env NTHU_CUDA_DOGLEG_MIN_BATCH=512
EOF
