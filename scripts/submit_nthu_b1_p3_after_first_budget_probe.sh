...
RESULT_TAG=${RESULT_TAG:-nthu_b1_p3_after_first_budget_probe}
OUT=${OUT:-"$ROOT/results/${RESULT_TAG}_summary.csv"}
VARIANTS_FILE=${VARIANTS_FILE:-"$ROOT/results/job_hooks/${RESULT_TAG}.variants"}
BUILD_DIR=${BUILD_DIR:-"$ROOT/external/nthu-route/build-release-openmp-OFF-cuda-ON-post-after-limit"}
...
nthu_b1_rscore4_p3m2_box48_75_afterlimit2000|$base_args --p3-init-box-size=48 --p3-box-expand-size=75|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=4 NTHU_POST_OVERFLOW_LIMIT_AFTER_FIRST=2000
nthu_b1_rscore4_p3m2_box48_75_afterlimit5000|$base_args --p3-init-box-size=48 --p3-box-expand-size=75|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=4 NTHU_POST_OVERFLOW_LIMIT_AFTER_FIRST=5000
nthu_b1_rscore5_p3m2_box58_95_afterlimit5000|$base_args --p3-init-box-size=58 --p3-box-expand-size=95|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=5 NTHU_POST_OVERFLOW_LIMIT_AFTER_FIRST=5000
EOF
