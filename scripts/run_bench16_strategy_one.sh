...
case "$STRATEGY" in
  ...
  nthu_p2p3_legal_repair)
    ...
    ;;
  nthu_p2p3_ultra_repair)
    ROUTER_LABEL="nthu_p2p3_ultra_repair"
    NTHU_OPENMP=OFF
    NTHU_CUDA=OFF
    BUILD_DIR="${NTHU_CPU_BUILD_DIR:-$ROOT/external/nthu-route/build-release-openmp-OFF}"
    NTHU_EXTRA_ARGS="--p2-init-box-size=8 --p2-box-expand-size=8 --p2-max-iteration=18 --overflow-threshold=0 --p3-max-iteration=60 --p3-init-box-size=100 --p3-box-expand-size=180"
    ENV_ASSIGNMENTS=(
      NTHU_FAST_GREEDY_LAYER=1
      NTHU_POST_SORT_MODE=edge_count
    )
    ;;
  nthu_p2p3_excess_repair)
    ROUTER_LABEL="nthu_p2p3_excess_repair"
    NTHU_OPENMP=OFF
    NTHU_CUDA=OFF
    BUILD_DIR="${NTHU_CPU_BUILD_DIR:-$ROOT/external/nthu-route/build-release-openmp-OFF}"
    NTHU_EXTRA_ARGS="--p2-init-box-size=8 --p2-box-expand-size=8 --p2-max-iteration=18 --overflow-threshold=0 --p3-max-iteration=70 --p3-init-box-size=100 --p3-box-expand-size=180"
    ENV_ASSIGNMENTS=(
      NTHU_FAST_GREEDY_LAYER=1
      NTHU_POST_SORT_MODE=impact
      NTHU_POST_REEVALUATE_COST=1
      NTHU_POST_EXCESS_EDGE_REPAIR=1
      NTHU_POST_EXCESS_EDGE_REPAIR_MULT=4
    )
    ;;
  nthu_p2p3_compact_excess_repair)
    ROUTER_LABEL="nthu_p2p3_compact_excess_repair"
    NTHU_OPENMP=OFF
    NTHU_CUDA=OFF
    BUILD_DIR="${NTHU_CPU_BUILD_DIR:-$ROOT/external/nthu-route/build-release-openmp-OFF}"
  ...
  nthu_p2p3_neighbor_excess_repair)
    ...
    ;;
  nthu_p2p3_aggressive_neighbor_repair)
    ROUTER_LABEL="nthu_p2p3_aggressive_neighbor_repair"
    NTHU_OPENMP=OFF
    NTHU_CUDA=OFF
    BUILD_DIR="${NTHU_CPU_BUILD_DIR:-$ROOT/external/nthu-route/build-release-openmp-OFF}"
    NTHU_EXTRA_ARGS="--p2-init-box-size=5 --p2-box-expand-size=5 --p2-max-iteration=30 --overflow-threshold=0 --p3-max-iteration=80 --p3-init-box-size=66 --p3-box-expand-size=122"
    ENV_ASSIGNMENTS=(
      NTHU_FAST_GREEDY_LAYER=1
      NTHU_POST_SORT_MODE=hot_density
      NTHU_POST_REEVALUATE_COST=1
      NTHU_POST_EXCESS_EDGE_REPAIR=1
      NTHU_POST_EXCESS_EDGE_REPAIR_MULT=8
      NTHU_POST_NEIGHBOR_REPAIR_RADIUS=2
    )
    ;;
  nthu_p2p3_broad_excess_repair)
    ROUTER_LABEL="nthu_p2p3_broad_excess_repair"
    NTHU_OPENMP=OFF
    NTHU_CUDA=OFF
    BUILD_DIR="${NTHU_CPU_BUILD_DIR:-$ROOT/external/nthu-route/build-release-openmp-OFF}"
    NTHU_EXTRA_ARGS="--p2-init-box-size=5 --p2-box-expand-size=5 --p2-max-iteration=30 --overflow-threshold=0 --p3-max-iteration=80 --p3-init-box-size=66 --p3-box-expand-size=122"
    ENV_ASSIGNMENTS=(
      ...
      NTHU_POST_EXCESS_EDGE_REPAIR=1
      NTHU_POST_EXCESS_EDGE_REPAIR_MULT=4
      NTHU_POST_EXCESS_EDGE_REPAIR_BROAD_AFTER_ITER=6
      NTHU_POST_NEIGHBOR_REPAIR_RADIUS=1
    )
    ;;
  nthu_p2p3_weighted_post_repair)
    ROUTER_LABEL="nthu_p2p3_weighted_post_repair"
    NTHU_OPENMP=OFF
    NTHU_CUDA=OFF
    BUILD_DIR="${NTHU_CPU_BUILD_DIR:-$ROOT/external/nthu-route/build-release-openmp-OFF}"
    NTHU_EXTRA_ARGS="--p2-init-box-size=5 --p2-box-expand-size=5 --p2-max-iteration=30 --overflow-threshold=0 --p3-max-iteration=80 --p3-init-box-size=66 --p3-box-expand-size=122"
    ENV_ASSIGNMENTS=(
      ...
      NTHU_POST_EXCESS_EDGE_REPAIR_MULT=4
      NTHU_POST_NEIGHBOR_REPAIR_RADIUS=1
      NTHU_POST_WEIGHTED_COST=1
      NTHU_POST_WEIGHTED_COST_SCALE=8
    )
    ;;
  nthu_p2p3_accept_broad_repair)
    ROUTER_LABEL="nthu_p2p3_accept_broad_repair"
    NTHU_OPENMP=OFF
    NTHU_CUDA=OFF
    BUILD_DIR="${NTHU_CPU_BUILD_DIR:-$ROOT/external/nthu-route/build-release-openmp-OFF}"
    NTHU_EXTRA_ARGS="--p2-init-box-size=5 --p2-box-expand-size=5 --p2-max-iteration=30 --overflow-threshold=0 --p3-max-iteration=80 --p3-init-box-size=66 --p3-box-expand-size=122"
    ENV_ASSIGNMENTS=(
      ...
      NTHU_POST_EXCESS_EDGE_REPAIR_BROAD_AFTER_ITER=6
      NTHU_POST_NEIGHBOR_REPAIR_RADIUS=1
      NTHU_POST_ACCEPT_IMPROVEMENT=1
      NTHU_POST_ACCEPT_MIN_DELTA=1
    )
    ;;
  nthu_p2p3_budget)
