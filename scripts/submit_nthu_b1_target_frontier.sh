...
RESULT_TAG=${RESULT_TAG:-nthu_b1_target_frontier}
...
nthu_b1_p2m3_th20000_p3m1_box66_122|$base_args --overflow-threshold=20000 --p2-max-iteration=3 --p3-max-iteration=1 --p3-init-box-size=66 --p3-box-expand-size=122|$base_env
nthu_b1_p2m3_th20000_p3m1_box35_50|$base_args --overflow-threshold=20000 --p2-max-iteration=3 --p3-max-iteration=1 --p3-init-box-size=35 --p3-box-expand-size=50|$base_env
nthu_b1_p2m4_th10000_p3m1_box66_122|$base_args --overflow-threshold=10000 --p2-max-iteration=4 --p3-max-iteration=1 --p3-init-box-size=66 --p3-box-expand-size=122|$base_env
nthu_b1_p2m4_th10000_p3m1_box35_50|$base_args --overflow-threshold=10000 --p2-max-iteration=4 --p3-max-iteration=1 --p3-init-box-size=35 --p3-box-expand-size=50|$base_env
EOF
