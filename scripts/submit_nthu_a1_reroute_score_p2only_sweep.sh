...
RESULT_TAG=${RESULT_TAG:-a1_reroute_score_p2only_sweep}
...
base_env="NTHU_FAST_GREEDY_LAYER=1 NTHU_REROUTE_SCORE_P2_ONLY=1"

cat > "$VARIANTS_FILE" <<EOF
nthu_a1_th1800_p2max6_p3box66_122_rscore2_p2only|$base_args --p2-max-iteration=6|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=2
nthu_a1_th1800_p2max6_p3box66_122_rscore3_p2only|$base_args --p2-max-iteration=6|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=3
nthu_a1_th1800_p2max5_p3box66_122_rscore2_p2only|$base_args --p2-max-iteration=5|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=2
nthu_a1_th1800_p2max5_p3box70_130_rscore2_p2only|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1800 --p2-max-iteration=5 --p3-init-box-size=70 --p3-box-expand-size=130|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=2
EOF
