...
RESULT_TAG=${RESULT_TAG:-a1_p2max6_p3box_ultra}
...
nthu_a1_th1800_p2max6_p3box60_110|--p2-init-box-size=5 --p2-box-expand-size=5 --p2-max-iteration=6 --overflow-threshold=1800 --p3-init-box-size=60 --p3-box-expand-size=110|NTHU_FAST_GREEDY_LAYER=1
nthu_a1_th1800_p2max6_p3box70_130|--p2-init-box-size=5 --p2-box-expand-size=5 --p2-max-iteration=6 --overflow-threshold=1800 --p3-init-box-size=70 --p3-box-expand-size=130|NTHU_FAST_GREEDY_LAYER=1
nthu_a1_th1700_p2max6_p3box50_90|--p2-init-box-size=5 --p2-box-expand-size=5 --p2-max-iteration=6 --overflow-threshold=1700 --p3-init-box-size=50 --p3-box-expand-size=90|NTHU_FAST_GREEDY_LAYER=1
nthu_a1_th1900_p2max6_p3box50_90|--p2-init-box-size=5 --p2-box-expand-size=5 --p2-max-iteration=6 --overflow-threshold=1900 --p3-init-box-size=50 --p3-box-expand-size=90|NTHU_FAST_GREEDY_LAYER=1
EOF
