...
RESULT_TAG=${RESULT_TAG:-nthu_b1_direct_frontier}
...
nthu_b1_direct20k_p2m3_p3m1_box66_122|$base_args --overflow-threshold=20000 --p2-max-iteration=3 --p3-max-iteration=1 --p3-init-box-size=66 --p3-box-expand-size=122|$base_env NTHU_DIRECT_OVERFLOW_LIMIT=20000
nthu_b1_direct40k_p2m3_p3m1_box66_122|$base_args --overflow-threshold=20000 --p2-max-iteration=3 --p3-max-iteration=1 --p3-init-box-size=66 --p3-box-expand-size=122|$base_env NTHU_DIRECT_OVERFLOW_LIMIT=40000
nthu_b1_direct20k_p2m4_p3m1_box42_65|$base_args --overflow-threshold=10000 --p2-max-iteration=4 --p3-max-iteration=1 --p3-init-box-size=42 --p3-box-expand-size=65|$base_env NTHU_DIRECT_OVERFLOW_LIMIT=20000
nthu_b1_direct40k_p2m4_p3m1_box42_65|$base_args --overflow-threshold=10000 --p2-max-iteration=4 --p3-max-iteration=1 --p3-init-box-size=42 --p3-box-expand-size=65|$base_env NTHU_DIRECT_OVERFLOW_LIMIT=40000
EOF
