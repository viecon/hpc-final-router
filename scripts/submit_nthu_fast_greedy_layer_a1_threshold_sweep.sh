...
RESULT_TAG=${RESULT_TAG:-fast_greedy_layer_a1_threshold_sweep}
...
nthu_a1_fast_layer_th1650|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1650 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1
nthu_a1_fast_layer_th1720|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1720 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1
EOF
