...
RESULT_TAG=${RESULT_TAG:-profile_a1_current_best}
...
nthu_a1_profile_fast_layer_th1800|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1800 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1 NTHU_PROFILE=1
EOF
