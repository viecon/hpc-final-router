...
RESULT_TAG=${RESULT_TAG:-fast_construct_probe_a1}
...
nthu_a1_fast_construct_th3000|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=3000 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1 NTHU_RANGE_SKIP_REMAINDER=1
nthu_a1_fast_construct_th5000|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=5000 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1 NTHU_RANGE_SKIP_REMAINDER=1
EOF
