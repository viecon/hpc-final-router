...
RESULT_TAG=${RESULT_TAG:-nthu_b1_second_p3_impact_probe}
OUT=${OUT:-"$ROOT/results/${RESULT_TAG}_summary.csv"}
VARIANTS_FILE=${VARIANTS_FILE:-"$ROOT/results/job_hooks/${RESULT_TAG}.variants"}
BUILD_DIR=${BUILD_DIR:-"$ROOT/external/nthu-route/build-release-openmp-OFF-cuda-ON-post-impact"}
...
nthu_b1_late4_p3box54_88_p3m2_impact_limit60|$base_args|$base_env NTHU_POST_SORT_MODE=impact NTHU_POST_OVERFLOW_LIMIT_AFTER_FIRST=60
nthu_b1_late4_p3box54_88_p3m2_impact_limit80|$base_args|$base_env NTHU_POST_SORT_MODE=impact NTHU_POST_OVERFLOW_LIMIT_AFTER_FIRST=80
nthu_b1_late4_p3box54_88_p3m2_hotdensity_limit60|$base_args|$base_env NTHU_POST_SORT_MODE=hot_density NTHU_POST_OVERFLOW_LIMIT_AFTER_FIRST=60
nthu_b1_late4_p3box54_88_p3m2_hotdensity_limit80|$base_args|$base_env NTHU_POST_SORT_MODE=hot_density NTHU_POST_OVERFLOW_LIMIT_AFTER_FIRST=80
nthu_b1_late4_p3box54_88_p3m2_impact_score6_limit100|$base_args|$base_env NTHU_POST_SORT_MODE=impact NTHU_POST_OVERFLOW_LIMIT_AFTER_FIRST=100 NTHU_POST_MIN_OVERFLOW_SCORE_AFTER_FIRST=6
nthu_b1_late4_p3box54_88_p3m2_hotdensity_score6_limit100|$base_args|$base_env NTHU_POST_SORT_MODE=hot_density NTHU_POST_OVERFLOW_LIMIT_AFTER_FIRST=100 NTHU_POST_MIN_OVERFLOW_SCORE_AFTER_FIRST=6
EOF
