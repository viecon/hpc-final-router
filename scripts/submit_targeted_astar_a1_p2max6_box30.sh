...
out=results/targeted_repairs/a1_th1800_p2max6_p3box30_50_astar.out
prefix=results/targeted_repairs/a1_th1800_p2max6_p3box30_50_astar
...
echo "$job" > results/job_hooks/submitted_targeted_astar_a1_p2max6_box30.jobid
nohup env WATCH_INTERVAL_SECONDS=20 WATCH_COMMAND="bash scripts/refresh_indexes.sh" \
  bash scripts/watch_job_then_run.sh "$job" targeted_astar_a1_p2max6_box30-refresh >/dev/null 2>&1 &
echo "$job"
