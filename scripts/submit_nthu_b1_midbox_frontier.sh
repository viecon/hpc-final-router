...
RESULT_TAG=${RESULT_TAG:-nthu_b1_midbox_frontier}
...
nthu_b1_p2m4_p3m1_box42_65|$base_args --p3-init-box-size=42 --p3-box-expand-size=65|$base_env
nthu_b1_p2m4_p3m1_box48_75|$base_args --p3-init-box-size=48 --p3-box-expand-size=75|$base_env
nthu_b1_p2m4_p3m1_box54_88|$base_args --p3-init-box-size=54 --p3-box-expand-size=88|$base_env
nthu_b1_p2m4_p3m1_box60_105|$base_args --p3-init-box-size=60 --p3-box-expand-size=105|$base_env
EOF
