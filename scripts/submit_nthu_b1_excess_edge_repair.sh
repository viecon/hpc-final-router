...
RESULT_TAG=${RESULT_TAG:-nthu_b1_excess_edge_repair}
...
nthu_b1_excess_m1_p3m4_profile|$base_args --p3-max-iteration=4|$base_env NTHU_POST_EXCESS_EDGE_REPAIR_MULT=1 NTHU_PROFILE=1
nthu_b1_excess_m2_p3m3|$base_args --p3-max-iteration=3|$base_env NTHU_POST_EXCESS_EDGE_REPAIR_MULT=2
nthu_b1_excess_m4_p3m2|$base_args --p3-max-iteration=2|$base_env NTHU_POST_EXCESS_EDGE_REPAIR_MULT=4
nthu_b1_excess_m2_p2m3_p3m4|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=20000 --p2-max-iteration=3 --p3-max-iteration=4 --p3-init-box-size=42 --p3-box-expand-size=65|$base_env NTHU_POST_EXCESS_EDGE_REPAIR_MULT=2
EOF
