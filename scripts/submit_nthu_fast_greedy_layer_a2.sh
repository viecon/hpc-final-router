...
RESULT_TAG=${RESULT_TAG:-fast_greedy_layer_a2}
...
nthu_a2_fast_greedy_layer|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=240|NTHU_FAST_GREEDY_LAYER=1
EOF
