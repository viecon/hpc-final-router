...
RESULT_TAG=${RESULT_TAG:-nthu_b1_p3_after_first_score_gate_probe}
...
nthu_b1_rscore4_p3m2_box48_75_postscore8|$base_args --p3-init-box-size=48 --p3-box-expand-size=75|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=4 NTHU_POST_MIN_OVERFLOW_SCORE_AFTER_FIRST=8
nthu_b1_rscore4_p3m2_box48_75_postscore12|$base_args --p3-init-box-size=48 --p3-box-expand-size=75|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=4 NTHU_POST_MIN_OVERFLOW_SCORE_AFTER_FIRST=12
nthu_b1_rscore5_p3m2_box57_92_postscore8|$base_args --p3-init-box-size=57 --p3-box-expand-size=92|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=5 NTHU_POST_MIN_OVERFLOW_SCORE_AFTER_FIRST=8
nthu_b1_rscore5_p3m2_box57_92_postscore12|$base_args --p3-init-box-size=57 --p3-box-expand-size=92|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=5 NTHU_POST_MIN_OVERFLOW_SCORE_AFTER_FIRST=12
EOF
