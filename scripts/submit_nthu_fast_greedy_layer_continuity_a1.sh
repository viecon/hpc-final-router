...
RESULT_TAG=${RESULT_TAG:-fast_greedy_layer_continuity_a1}
...
nthu_a1_fast_layer_continuity|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1700 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1 NTHU_FAST_GREEDY_LAYER_CONTINUITY=1
EOF
