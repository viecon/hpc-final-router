...
RESULT_TAG=${RESULT_TAG:-construct_only_frontier}
...
nthu_a1_construct_only_th10000|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=10000 --p3-max-iteration=0 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1 NTHU_RANGE_SKIP_REMAINDER=1
nthu_a1_construct_only_th50000|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=50000 --p3-max-iteration=0 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1 NTHU_RANGE_SKIP_REMAINDER=1
EOF
