...
RESULT_TAG=${RESULT_TAG:-nthu_b1_rscore5_p3_budget_probe}
...
base_env="NTHU_FAST_GREEDY_LAYER=1 NTHU_DOGLEG_FASTPATH=1 NTHU_DOGLEG_MAX_EXTRA=0 NTHU_DOGLEG_MIN_SCORE=1 NTHU_DOGLEG_STEP=8 NTHU_RANGE_SKIP_REMAINDER=1 NTHU_REROUTE_SCORE_P2_ONLY=1 NTHU_REROUTE_MIN_OVERFLOW_SCORE=5"

cat > "$VARIANTS_FILE" <<EOF
nthu_b1_rscore5_p3m2_box42_65_limit5000|$base_args --p3-init-box-size=42 --p3-box-expand-size=65|$base_env NTHU_POST_OVERFLOW_LIMIT=5000
nthu_b1_rscore5_p3m2_box42_65_limit10000|$base_args --p3-init-box-size=42 --p3-box-expand-size=65|$base_env NTHU_POST_OVERFLOW_LIMIT=10000
nthu_b1_rscore5_p3m2_box50_80_limit5000|$base_args --p3-init-box-size=50 --p3-box-expand-size=80|$base_env NTHU_POST_OVERFLOW_LIMIT=5000
EOF
