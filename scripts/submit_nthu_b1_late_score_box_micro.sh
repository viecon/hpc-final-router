...
RESULT_TAG=${RESULT_TAG:-nthu_b1_late_score_box_micro}
...
nthu_b1_score5_late4_p3box48_75|$base_args --p3-init-box-size=48 --p3-box-expand-size=75|$base_env
nthu_b1_score5_late4_p3box50_80|$base_args --p3-init-box-size=50 --p3-box-expand-size=80|$base_env
nthu_b1_score5_late4_p3box52_84|$base_args --p3-init-box-size=52 --p3-box-expand-size=84|$base_env
nthu_b1_score5_late4_p3box53_86|$base_args --p3-init-box-size=53 --p3-box-expand-size=86|$base_env
EOF
