...
RESULT_TAG=${RESULT_TAG:-nthu_b1_rscore5_big_p3_probe}
...
nthu_b1_rscore5_no_cuda_p3box50_80|$base_args --p3-init-box-size=50 --p3-box-expand-size=80|$base_env
nthu_b1_rscore5_no_cuda_p3box58_95|$base_args --p3-init-box-size=58 --p3-box-expand-size=95|$base_env
nthu_b1_rscore5_no_cuda_p3box66_110|$base_args --p3-init-box-size=66 --p3-box-expand-size=110|$base_env
nthu_b1_rscore5_no_cuda_p3box74_125|$base_args --p3-init-box-size=74 --p3-box-expand-size=125|$base_env
EOF
