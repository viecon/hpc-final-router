...
cp external/nctu-gr/Parameter_Files/RegularDefault.set "$PARAM_DIR/default.set"
write_param "$PARAM_DIR/wl20_p1m1_maze6_greedy.set" 20 1 1 6 1 1 1
write_param "$PARAM_DIR/wl50_p2m2_maze20_greedy.set" 50 2 2 20 1 1 3.5
write_param "$PARAM_DIR/wl20_p1m1_maze10_dp.set" 20 1 1 10 1 2 1
