...
RESULT_TAG=${RESULT_TAG:-nthu_b1_overflow_sort_frontier}
...
base_env="NTHU_FAST_GREEDY_LAYER=1 NTHU_DOGLEG_FASTPATH=1 NTHU_DOGLEG_MAX_EXTRA=0 NTHU_DOGLEG_MIN_SCORE=1 NTHU_DOGLEG_STEP=8 NTHU_RANGE_SKIP_REMAINDER=1 NTHU_CUDA_COSTED_MAZE_FASTPATH=1 NTHU_CUDA_MAZE_MAX_AREA=256 NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=42 NTHU_RANGE_SORT_BY_OVERFLOW_SCORE=1"

cat > "$VARIANTS_FILE" <<EOF
nthu_b1_sortscore_p2m4_p3m1_box42_65|$base_args --p3-max-iteration=1|$base_env
nthu_b1_sortscore_p2m4_p3m2_postlimit40k|$base_args --p3-max-iteration=2|$base_env NTHU_POST_OVERFLOW_LIMIT=40000
nthu_b1_sortscore_p2m3_p3m1_box66_122|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=20000 --p2-max-iteration=3 --p3-max-iteration=1 --p3-init-box-size=66 --p3-box-expand-size=122|$base_env
EOF
