...
case "$STRATEGY" in
  ...
  frontier_v8_direct_proposal)
    ...
    strategy_env=(
      ...
      NTHU_REROUTE_LATE_MIN_OVERFLOW_SCORE=1
      NTHU_POST_SORT_MODE=edge_count
      NTHU_POST_OVERFLOW_LIMIT_AFTER_FIRST=${V8_POST_OVERFLOW_LIMIT_AFTER_FIRST:-240}
      NTHU_POST_STALL_LIMIT=${V8_POST_STALL_LIMIT:-0}
      NTHU_POST_STALL_MIN_OVERFLOW=${V8_POST_STALL_MIN_OVERFLOW:-0}
      NTHU_POST_STALL_MIN_DELTA=${V8_POST_STALL_MIN_DELTA:-1}
      NTHU_ADAPTIVE_LEGAL_REPAIR=1
      NTHU_ADAPTIVE_POST_ONLY_OVERFLOW_LIMIT=10
      NTHU_ADAPTIVE_REPAIR_P2_MAX_ITER=${V8_ADAPTIVE_REPAIR_P2_MAX_ITER:-8}
      NTHU_ADAPTIVE_HIGH_OVERFLOW_P2_TRIGGER=200
      NTHU_ADAPTIVE_HIGH_OVERFLOW_P2_MAX_ITER=${V8_ADAPTIVE_HIGH_OVERFLOW_P2_MAX_ITER:-16}
      NTHU_ADAPTIVE_SMALL_OVERFLOW_P2_LIMIT=50
      NTHU_ADAPTIVE_SMALL_OVERFLOW_P2_ROUNDS=1
      NTHU_V8_ADAPTIVE_LOW_TAIL_EXIT_LIMIT=${V8_ADAPTIVE_LOW_TAIL_EXIT_LIMIT:-0}
      NTHU_ADAPTIVE_INITIAL_P3_MAX_ITER=2
      NTHU_ADAPTIVE_INITIAL_P3_INIT_BOX=54
      NTHU_ADAPTIVE_INITIAL_P3_BOX_INC=88
      NTHU_ADAPTIVE_REPAIR_P3_MAX_ITER=12
      NTHU_ADAPTIVE_REPAIR_P3_INIT_BOX=66
      NTHU_ADAPTIVE_REPAIR_P3_BOX_INC=122
      NTHU_FINAL_FULL_REMAINDER_REPAIR_LIMIT=${V8_FINAL_FULL_REMAINDER_REPAIR_LIMIT:-80}
      NTHU_FINAL_FULL_REMAINDER_REPAIR_ROUNDS=${V8_FINAL_FULL_REMAINDER_REPAIR_ROUNDS:-6}
      NTHU_PROPOSAL_REROUTE_BATCHES=1
      NTHU_PROPOSAL_REROUTE_MAZE=1
      NTHU_PROPOSAL_REROUTE_LOG=1
      ...
      NTHU_PROPOSAL_REROUTE_IMPROVEMENT_COMMIT=1
      NTHU_PROPOSAL_REROUTE_GLOBAL_COMMIT_LIMIT=${V8_PROPOSAL_GLOBAL_COMMIT_LIMIT:-0}
      NTHU_PROPOSAL_REROUTE_GLOBAL_COMMIT_MAX_TESTS=${V8_PROPOSAL_GLOBAL_COMMIT_MAX_TESTS:-0}
      NTHU_PROPOSAL_REROUTE_GLOBAL_COMMIT_POST_ONLY=${V8_PROPOSAL_GLOBAL_COMMIT_POST_ONLY:-}
      NTHU_PROPOSAL_REROUTE_RIPUP_BEFORE_PROPOSE=1
      NTHU_PROPOSAL_REROUTE_SAFE_COMMIT=${V8_PROPOSAL_SAFE_COMMIT:-}
      NTHU_PROPOSAL_REROUTE_ADAPTIVE_ROUNDS=1
      NTHU_PROPOSAL_REROUTE_LOW_OVERFLOW_LIMIT=${V8_PROPOSAL_LOW_OVERFLOW_LIMIT:-1000}
      NTHU_PROPOSAL_REROUTE_LOW_MAX_ROUNDS=${V8_PROPOSAL_LOW_MAX_ROUNDS:-2}
      NTHU_V8_PROPOSAL_PARALLEL=${V8_PROPOSAL_PARALLEL:-0}
      NTHU_V8_TRANSACTIONAL_PROPOSAL_WAVES=${V8_TRANSACTIONAL_PROPOSAL_WAVES:-}
      NTHU_V8_TRANSACTIONAL_PROPOSAL_WAVE_SIZE=${V8_TRANSACTIONAL_PROPOSAL_WAVE_SIZE:-256}
      NTHU_V8_TRANSACTIONAL_PROPOSAL_GLOBAL_GATE=${V8_TRANSACTIONAL_PROPOSAL_GLOBAL_GATE:-1}
      NTHU_V8_TRANSACTIONAL_PROPOSAL_REQUIRE_PROGRESS=${V8_TRANSACTIONAL_PROPOSAL_REQUIRE_PROGRESS:-}
      NTHU_STRICT_LEGAL_MAZE=${V8_STRICT_LEGAL_MAZE:-}
      NTHU_STRICT_LEGAL_MAZE_POST_ONLY=${V8_STRICT_LEGAL_MAZE_POST_ONLY:-}
      NTHU_STRICT_LEGAL_MAZE_MAX_AREA=${V8_STRICT_LEGAL_MAZE_MAX_AREA:-250000}
      NTHU_STRICT_LEGAL_MAZE_MIN_ITER=${V8_STRICT_LEGAL_MAZE_MIN_ITER:--1}
      NTHU_V8_STRICT_LEGAL_REPAIR=${V8_STRICT_LEGAL_REPAIR:-}
      NTHU_V8_STRICT_LEGAL_REPAIR_POST_ONLY=${V8_STRICT_LEGAL_REPAIR_POST_ONLY:-}
      NTHU_V8_STRICT_LEGAL_REPAIR_TRIGGER=${V8_STRICT_LEGAL_REPAIR_TRIGGER:-1}
      NTHU_V8_STRICT_LEGAL_REPAIR_MAX_OVERFLOW=${V8_STRICT_LEGAL_REPAIR_MAX_OVERFLOW:-0}
      NTHU_V8_STRICT_LEGAL_REPAIR_ROUNDS=${V8_STRICT_LEGAL_REPAIR_ROUNDS:-4}
      NTHU_V8_STRICT_LEGAL_REPAIR_MAX_CANDIDATES=${V8_STRICT_LEGAL_REPAIR_MAX_CANDIDATES:-1024}
      NTHU_V8_STRICT_LEGAL_REPAIR_BATCH_SIZE=${V8_STRICT_LEGAL_REPAIR_BATCH_SIZE:-256}
      NTHU_V8_STRICT_LEGAL_REPAIR_EDGE_QUOTA=${V8_STRICT_LEGAL_REPAIR_EDGE_QUOTA:-1}
      NTHU_V8_STRICT_LEGAL_REPAIR_BASE_BOX=${V8_STRICT_LEGAL_REPAIR_BASE_BOX:-0}
      NTHU_V8_STRICT_LEGAL_REPAIR_FIXED_BASE_BOX=${V8_STRICT_LEGAL_REPAIR_FIXED_BASE_BOX:-}
      NTHU_V8_STRICT_LEGAL_REPAIR_BOX_INC=${V8_STRICT_LEGAL_REPAIR_BOX_INC:-64}
      NTHU_V8_STRICT_LEGAL_REPAIR_MAX_NO_PROGRESS=${V8_STRICT_LEGAL_REPAIR_MAX_NO_PROGRESS:-2}
      NTHU_V8_STRICT_LEGAL_REPAIR_SNAPSHOT_COMMIT=${V8_STRICT_LEGAL_REPAIR_SNAPSHOT_COMMIT:-}
      NTHU_V8_STRICT_LEGAL_REPAIR_SNAPSHOT_COMMIT_MAX_OVERFLOW=${V8_STRICT_LEGAL_REPAIR_SNAPSHOT_COMMIT_MAX_OVERFLOW:-0}
      NTHU_V8_STRICT_LEGAL_REPAIR_SNAPSHOT_ROLLBACK=${V8_STRICT_LEGAL_REPAIR_SNAPSHOT_ROLLBACK:-}
      NTHU_V8_STRICT_LEGAL_REPAIR_ROLLBACK_NO_PROGRESS=${V8_STRICT_LEGAL_REPAIR_ROLLBACK_NO_PROGRESS:-}
      NTHU_V8_STRICT_LEGAL_REPAIR_SNAPSHOT_GLOBAL_GATE=${V8_STRICT_LEGAL_REPAIR_SNAPSHOT_GLOBAL_GATE:-}
      NTHU_V8_STRICT_LEGAL_REPAIR_SNAPSHOT_BURST_TOTAL=${V8_STRICT_LEGAL_REPAIR_SNAPSHOT_BURST_TOTAL:-0}
      NTHU_V8_STRICT_LEGAL_REPAIR_SNAPSHOT_BURST_MAX=${V8_STRICT_LEGAL_REPAIR_SNAPSHOT_BURST_MAX:-0}
      NTHU_V8_STRICT_LEGAL_REPAIR_IMPROVEMENT_COMMIT=${V8_STRICT_LEGAL_REPAIR_IMPROVEMENT_COMMIT:-}
      NTHU_V8_STRICT_LEGAL_REPAIR_REUSE_INPUTS=${V8_STRICT_LEGAL_REPAIR_REUSE_INPUTS:-}
      NTHU_V8_STRICT_LEGAL_REPAIR_OVERFLOW_NET_INPUTS=${V8_STRICT_LEGAL_REPAIR_OVERFLOW_NET_INPUTS:-}
      NTHU_V8_STRICT_LEGAL_REPAIR_DYNAMIC_EDGE_QUOTA=${V8_STRICT_LEGAL_REPAIR_DYNAMIC_EDGE_QUOTA:-}
      NTHU_V8_STRICT_REPAIR_ALLOW_SAME_NET=${V8_STRICT_REPAIR_ALLOW_SAME_NET:-}
      NTHU_V8_REJECT_COOLDOWN=1
      NTHU_V8_LOW_OVERFLOW_EDGE_OVERSUBSCRIBE=${V8_LOW_OVERFLOW_EDGE_OVERSUBSCRIBE:-}
      NTHU_V8_LOW_TAIL_GLOBAL_REPAIR=1
      NTHU_V8_LOW_TAIL_POST_ONLY=${V8_LOW_TAIL_POST_ONLY:-}
      ...
      NTHU_V8_LOW_TAIL_SELF_RIPUP=1
      NTHU_V8_LOW_TAIL_SELF_RIPUP_PROPOSAL=${V8_LOW_TAIL_SELF_RIPUP_PROPOSAL:-}
      NTHU_V8_LOW_TAIL_SELF_RIPUP_BOX_INC=${V8_LOW_TAIL_SELF_RIPUP_BOX_INC:-122}
      NTHU_V8_LOW_TAIL_SELF_RIPUP_MAX_TESTS=${V8_LOW_TAIL_SELF_RIPUP_MAX_TESTS:-32}
      NTHU_V8_LOW_TAIL_SELF_RIPUP_BURST_TOTAL=${V8_LOW_TAIL_SELF_RIPUP_BURST_TOTAL:-0}
      NTHU_V8_LOW_TAIL_SELF_RIPUP_BURST_MAX=${V8_LOW_TAIL_SELF_RIPUP_BURST_MAX:-0}
      NTHU_V8_LOW_TAIL_SELF_RIPUP_BURST_ROUND_LIMIT=${V8_LOW_TAIL_SELF_RIPUP_BURST_ROUND_LIMIT:-}
      NTHU_V8_LOW_TAIL_STRICT_CAPACITY=${V8_LOW_TAIL_STRICT_CAPACITY:-}
      NTHU_V8_EMERGENCY_REPAIR=1
      NTHU_V8_EMERGENCY_REPAIR_TRIGGER=${V8_EMERGENCY_REPAIR_TRIGGER:-0}
      NTHU_V8_EMERGENCY_EARLY_TRIGGER=${V8_EMERGENCY_EARLY_TRIGGER:-30000}
      NTHU_V8_EMERGENCY_P2_MAX_ITER=${V8_EMERGENCY_P2_MAX_ITER:-48}
