...
RESULT_TAG=${RESULT_TAG:-fast_greedy_layer_continuity_a2}
...
nthu_a2_fast_layer_cont_th240|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=240|NTHU_FAST_GREEDY_LAYER=1 NTHU_FAST_GREEDY_LAYER_CONTINUITY=1
nthu_a2_fast_layer_cont_th225|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=225|NTHU_FAST_GREEDY_LAYER=1 NTHU_FAST_GREEDY_LAYER_CONTINUITY=1
EOF
