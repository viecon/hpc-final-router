...
RESULT_TAG=${RESULT_TAG:-nthu_b1_post_sort_p3m1_probe}
OUT=${OUT:-"$ROOT/results/${RESULT_TAG}_summary.csv"}
VARIANTS_FILE=${VARIANTS_FILE:-"$ROOT/results/job_hooks/${RESULT_TAG}.variants"}
BUILD_DIR=${BUILD_DIR:-"$ROOT/external/nthu-route/build-release-openmp-OFF-cuda-ON-post-sort"}
...
nthu_b1_rscore4_p3m1_box48_75_postsort_short|$base_args --p3-init-box-size=48 --p3-box-expand-size=75|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=4 NTHU_POST_SORT_MODE=short_first
nthu_b1_rscore4_p3m1_box48_75_postsort_density|$base_args --p3-init-box-size=48 --p3-box-expand-size=75|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=4 NTHU_POST_SORT_MODE=density
nthu_b1_rscore5_p3m1_box57_92_postsort_short|$base_args --p3-init-box-size=57 --p3-box-expand-size=92|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=5 NTHU_POST_SORT_MODE=short_first
nthu_b1_rscore5_p3m1_box57_92_postsort_density|$base_args --p3-init-box-size=57 --p3-box-expand-size=92|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=5 NTHU_POST_SORT_MODE=density
EOF
