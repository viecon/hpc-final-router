...
RESULT_TAG=${RESULT_TAG:-nthu_b1_late_full_p2_probe}
...
base_env="NTHU_FAST_GREEDY_LAYER=1 NTHU_DOGLEG_FASTPATH=1 NTHU_DOGLEG_MAX_EXTRA=0 NTHU_DOGLEG_MIN_SCORE=1 NTHU_DOGLEG_STEP=8 NTHU_RANGE_SKIP_REMAINDER=1"

cat > "$VARIANTS_FILE" <<EOF
nthu_b1_rscore4_until4_p3box44_68|$base_args --p3-init-box-size=44 --p3-box-expand-size=68|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=4 NTHU_REROUTE_SCORE_UNTIL_ITER=4
nthu_b1_rscore4_until4_p3box46_72|$base_args --p3-init-box-size=46 --p3-box-expand-size=72|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=4 NTHU_REROUTE_SCORE_UNTIL_ITER=4
nthu_b1_rscore5_until4_p3box46_72|$base_args --p3-init-box-size=46 --p3-box-expand-size=72|$base_env NTHU_REROUTE_MIN_OVERFLOW_SCORE=5 NTHU_REROUTE_SCORE_UNTIL_ITER=4
EOF
