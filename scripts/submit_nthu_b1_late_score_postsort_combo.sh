...
RESULT_TAG=${RESULT_TAG:-nthu_b1_late_score_postsort_combo}
...
nthu_b1_late4_p3box52_84_short|$base_args --p3-init-box-size=52 --p3-box-expand-size=84|$base_env NTHU_POST_SORT_MODE=short_first
nthu_b1_late4_p3box53_86_short|$base_args --p3-init-box-size=53 --p3-box-expand-size=86|$base_env NTHU_POST_SORT_MODE=short_first
nthu_b1_late4_p3box54_88_short|$base_args --p3-init-box-size=54 --p3-box-expand-size=88|$base_env NTHU_POST_SORT_MODE=short_first
EOF
