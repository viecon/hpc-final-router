...
RESULT_TAG=${RESULT_TAG:-fast_greedy_layer_a2_conservative}
...
nthu_a2_fast_layer_th225|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=225|NTHU_FAST_GREEDY_LAYER=1
nthu_a2_fast_layer_th200|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=200|NTHU_FAST_GREEDY_LAYER=1
EOF
