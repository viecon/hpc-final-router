...
RESULT_TAG=${RESULT_TAG:-nthu_b1_rscore_p3box_micro}
...
base_env="NTHU_FAST_GREEDY_LAYER=1 NTHU_DOGLEG_FASTPATH=1 NTHU_DOGLEG_MAX_EXTRA=0 NTHU_DOGLEG_MIN_SCORE=1 NTHU_DOGLEG_STEP=8 NTHU_RANGE_SKIP_REMAINDER=1 NTHU_REROUTE_SCORE_P2_ONLY=1 NTHU_REROUTE_MIN_OVERFLOW_SCORE=4"
...
nthu_b1_rscore4_no_cuda_p3box44_68|$base_args --p3-init-box-size=44 --p3-box-expand-size=68|$base_env
nthu_b1_rscore4_no_cuda_p3box46_72|$base_args --p3-init-box-size=46 --p3-box-expand-size=72|$base_env
nthu_b1_rscore4_no_cuda_p3box48_75|$base_args --p3-init-box-size=48 --p3-box-expand-size=75|$base_env
nthu_b1_rscore4_no_cuda_p3box50_80|$base_args --p3-init-box-size=50 --p3-box-expand-size=80|$base_env
EOF
