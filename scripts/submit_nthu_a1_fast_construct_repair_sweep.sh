...
RESULT_TAG=${RESULT_TAG:-a1_fast_construct_repair_sweep}
...
nthu_a1_fast_repair_p3iter40|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=5000 --p3-max-iteration=40 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1 NTHU_RANGE_SKIP_REMAINDER=1
nthu_a1_fast_repair_p3iter60|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=5000 --p3-max-iteration=60 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1 NTHU_RANGE_SKIP_REMAINDER=1
nthu_a1_fast_repair_p3big40|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=5000 --p3-max-iteration=40 --p3-init-box-size=30 --p3-box-expand-size=50|NTHU_FAST_GREEDY_LAYER=1 NTHU_RANGE_SKIP_REMAINDER=1
EOF
