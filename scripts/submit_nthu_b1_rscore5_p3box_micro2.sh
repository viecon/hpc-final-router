...
RESULT_TAG=${RESULT_TAG:-nthu_b1_rscore5_p3box_micro2}
...
nthu_b1_rscore5_no_cuda_p3box54_88|$base_args --p3-init-box-size=54 --p3-box-expand-size=88|$base_env
nthu_b1_rscore5_no_cuda_p3box56_90|$base_args --p3-init-box-size=56 --p3-box-expand-size=90|$base_env
nthu_b1_rscore5_no_cuda_p3box57_92|$base_args --p3-init-box-size=57 --p3-box-expand-size=92|$base_env
EOF
