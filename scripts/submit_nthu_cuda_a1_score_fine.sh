...
RESULT_TAG=${RESULT_TAG:-cuda_a1_score_fine}
...
base_env="NTHU_FAST_GREEDY_LAYER=1 NTHU_RANGE_SKIP_REMAINDER=1 NTHU_CUDA_COSTED_MAZE_FASTPATH=1 NTHU_CUDA_MAZE_MAX_AREA=256"
args="--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=10000 --p3-max-iteration=60 --p3-init-box-size=30 --p3-box-expand-size=50"

cat > "$VARIANTS_FILE" <<EOF
nthu_cuda_a1_th10000_p3big60_score15|$args|$base_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=15
nthu_cuda_a1_th10000_p3big60_score20|$args|$base_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=20
nthu_cuda_a1_th10000_p3big60_score30|$args|$base_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=30
nthu_cuda_a1_th10000_p3big60_score35|$args|$base_env NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=35
EOF
