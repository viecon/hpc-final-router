...
RESULT_TAG=${RESULT_TAG:-fast_greedy_layer_a1_threshold_fine2}
...
nthu_a1_fast_layer_th1750|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1750 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1
nthu_a1_fast_layer_th1850|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1850 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1
nthu_a1_fast_layer_th1900|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1900 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1
nthu_a1_fast_layer_th1950|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=1950 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1
EOF
