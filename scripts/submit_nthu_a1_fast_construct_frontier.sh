...
RESULT_TAG=${RESULT_TAG:-a1_fast_construct_frontier}
...
nthu_a1_frontier_th10000|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=10000 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1 NTHU_RANGE_SKIP_REMAINDER=1
nthu_a1_frontier_th20000|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=20000 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1 NTHU_RANGE_SKIP_REMAINDER=1
nthu_a1_frontier_th50000|--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=50000 --p3-init-box-size=20 --p3-box-expand-size=30|NTHU_FAST_GREEDY_LAYER=1 NTHU_RANGE_SKIP_REMAINDER=1
EOF
