...
RESULT_TAG=${RESULT_TAG:-nthu_b1_layer_assignment_probe}
...
base_args="--p2-init-box-size=5 --p2-box-expand-size=5 --overflow-threshold=10000 --p2-max-iteration=4 --p3-max-iteration=1"
fast_2d_env="NTHU_DOGLEG_FASTPATH=1 NTHU_DOGLEG_MAX_EXTRA=0 NTHU_DOGLEG_MIN_SCORE=1 NTHU_DOGLEG_STEP=8 NTHU_RANGE_SKIP_REMAINDER=1 NTHU_CUDA_COSTED_MAZE_FASTPATH=1 NTHU_CUDA_MAZE_MAX_AREA=256 NTHU_CUDA_MAZE_MIN_OVERFLOW_SCORE=42"

cat > "$VARIANTS_FILE" <<EOF
nthu_b1_default_layer_p3box42_65|$base_args --p3-init-box-size=42 --p3-box-expand-size=65|$fast_2d_env
nthu_b1_default_layer_p3box66_122|$base_args --p3-init-box-size=66 --p3-box-expand-size=122|$fast_2d_env
EOF
