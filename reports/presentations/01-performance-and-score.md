# Performance and Score Brief

Date: 2026-06-06

## Slide 1 - 問題是什麼：VLSI Global Routing
...
| Scope | Cases | Original runtime | Original legality |
| --- | --- | ---: | --- |
...
## Slide 4 - 從 main branch docs 找到的起點
...
Sources checked on `origin/main`; current renamed copies:
...
| Benchmark | Original legal | Original s | Current s | Speedup | Current overflow |
| --- | --- | ---: | ---: | ---: | ---: |
...
## Slide 8 - 跟 main branch 同 CLI 比較
...
## Slide 10 - 快速但不能當 final 的結果

前面實驗有些數字很快，但不能混成最後成果：

| Result type | Example | 為什麼不能直接當 final |
| --- | --- | --- |
